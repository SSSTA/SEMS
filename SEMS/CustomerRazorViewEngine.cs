...
namespace SEMS
{
    public class CustomerRazorViewEngine : RazorViewEngine
    {
            ...
            : base()
        {
            ...
            //Area模版路径
            AreaMasterLocationFormats = new[] { "~/Views/Shared/{0}.cshtml", "~/Views/{2}/Shared/{0}.cshtml", };    //默认的怎么指定？_Layout.cshtml？无效"~/Views/{2}/Shared/_Layout.cshtml"
            //Area的分部视图路径
            AreaPartialViewLocationFormats = new[] { "~/Views/{2}/{1}/{0}.cshtml", "~/Views/Shared/{0}.cshtml", "~/Views/{2}/Shared/{0}.cshtml" };
            //主视图路径
